...
{
    [TestFixture]
    public class UsingTestServerWithWireMockAndConfigurationParameterTests
    {
            ...
            var webHostBuilder = new WebHostBuilder()
                ...
                .ConfigureAppConfiguration(configurationBuilder =>
                {
                    configurationBuilder.AddInMemoryCollection(
                        ...
                        {
                            ["ExternalServiceUrl"] = _externalServiceMock.Urls[0]
                        });
                });
        ...
        public async Task Get()
        {
            ...
            var response = await _restClient.ExecuteGetAsync<TodoItem>(new RestRequest("/externalviaconftodos/1"));
